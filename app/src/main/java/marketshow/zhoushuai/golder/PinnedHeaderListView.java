...
/**
 * Created by zhoushuai on 2016/11/3.
 */
public class PinnedHeaderListView extends ListView implements OnScrollListener {

    private OnScrollListener mOnScrollListener;  //给右边的ListView定义滚动监听


//声明一个钉头适配器 ，根据listview的华东定位到当前标题位置
    ...
    public static abstract class OnItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int rawPosition, long id) {
            ShopDetailShowAdapter adapter;
            if (adapterView.getAdapter().getClass().equals(HeaderViewListAdapter.class)) {
                HeaderViewListAdapter wrapperAdapter = (HeaderViewListAdapter) adapterView.getAdapter();
                adapter = (ShopDetailShowAdapter) wrapperAdapter.getWrappedAdapter();
            } else {
                adapter = (ShopDetailShowAdapter) adapterView.getAdapter();
            }
